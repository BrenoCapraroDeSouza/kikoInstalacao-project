  ...
  const DoubtsArray = [
    {
      id: 0,
      question:
        'De quanto em quanto tempo tenho que trocar as mangueiras e válvulas?',
      answer:
        'As mangueiras e válvulas devem ser substituídas regularmente de acordo com o prazo de validade indicado pelos fabricantes, geralmente a cada 5 anos. Esta prática é essencial para garantir o funcionamento seguro e eficiente, prevenindo falhas decorrentes do desgaste natural dos materiais ao longo do tempo. Inspeções regulares também são recomendadas para identificar sinais de desgaste antecipado ou danos.',
    },
    {
      id: 1,
      question:
        'Minhas panelas começaram a ficar pretas, qual pode ser o motivo?',
      answer:
        'A coloração preta nas panelas pode ser devido a uma regulagem inadequada do fogão, que pode levar à combustão incompleta do gás. Isso resulta na liberação de fuligem, que se deposita nas panelas. Esse problema não está diretamente relacionado ao tipo de gás utilizado, como o GLP (gás liquefeito de petróleo), mas sim à maneira como o fogão está queimando o combustível.',
    },
    {
      id: 2,
